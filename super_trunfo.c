...
// Programa para cadastrar, calcular e comparar duas cartas do Super Trunfo de Países baseado no atributo PIB
...
int main()
{
    ...
    // Comparação das cartas com base no atributo PIB
    ...
    // Determina e exibe o resultado da comparação
    if (pib1 > pib2)
    {
